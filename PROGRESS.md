...
- [x] NotificationsScreen - Dark fintech-style profile module with reusable notification tile widget, dynamic mock notification list, unread state handling, mark-all-as-read action, and empty state fallback.
